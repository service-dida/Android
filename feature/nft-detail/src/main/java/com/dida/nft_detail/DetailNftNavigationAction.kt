...
sealed class DetailNftNavigationAction {
    ...
    class NavigateToBuyNft(
        val nftId: Long, val nftImg: String, val nftTitle: String, val userImg: String,
        val userName: String, val price: String, val viewerNickName: String, val marketId: Long
    ) : DetailNftNavigationAction()
    ...
    class NavigateToImageDetail(val imageUrl: String?): DetailNftNavigationAction()
}
